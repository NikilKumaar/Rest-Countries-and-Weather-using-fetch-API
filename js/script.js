...
h1.innerText = "Countries with Weather Information";
...
async function countryAndWeather() {
  countriesRow.innerHTML = "<h4 class = 'text-center>Please wait...</h4>";
  try {
...
async function getWeather(lat, lon, id) {
  ...
  weatherData.innerHTML = `<h4 class = 'text-center'>Loading weather...</h4>`;
